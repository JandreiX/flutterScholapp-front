...
class Api {
  ...
  Future addItem (var data) async {
    ...
    if(data['picture'] == "assets/bg2.png") {
      ByteData byteData = await rootBundle.load('assets/bg2.png');
      List <int> imageData = byteData.buffer.asUint8List();
      file = http.MultipartFile.fromBytes('picture', imageData, filename: "bg2.png");
    }
    else {
